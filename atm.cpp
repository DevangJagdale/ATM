...
//C++ program to write ,read ,update and delete user object using read ,write ,update and delete function.
#include <iostream>
#include <fstream>
#include<string.h>
#include<limits> 
...
//class atm to read ,write ,update and delete user details
class atm
{
    private:
        char username[30];
    ...
    public:
        ...
        void showData(void)
        {
        cout<<"Username:"<<username<<",Password:"<<password<<",Balance:"<<balance<<endl;
        }
    ...
    int searchspecificusertodisplay(char *);
};
...
int atm :: adduser(){
    ...
    file.write((char*)&a,sizeof(a));    //write into file
...
int atm :: viewallusers(){
    ...
    while(!file1.eof())
    {
    	a.showData(); //display data on monitor
    	file1.read((char*)&a,sizeof(a));
 	}
...
int atm :: searchuser(char *uname, int pass){
...
int atm :: searchspecificusertodisplay(char *uname){
	atm a;
	fstream file1;
	file1.open("aaa.txt",ios::in);
	if(!file1){
			...
			if(found)
			{
				...
				switch(ch2)
				{
					...
					case 2:
						...
						goto user;
					case 3:
						a.searchspecificusertodisplay(uname);
						//sleep(4);
						goto user;
					case 4:
						cout<<"Thank you";
